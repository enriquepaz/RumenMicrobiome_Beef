...
usearch7.0.1090 -derep_fulllength contigs_for_uparse.fasta -sizeout -output usearch_outputs/derep.fa

#Sort sequences by decreasing size annotation (cluster size) not including singletons
usearch7.0.1090 -sortbysize usearch_outputs/derep.fa -minsize 2 -output usearch_outputs/derep.sort.fa

#Generate fasta file containing OTU representative sequences
usearch7.0.1090 -cluster_otus usearch_outputs/derep.sort.fa -otus usearch_outputs/otus1.fa

#Decompress gold.fasta.gz
gzip -d gold.fasta.gz

#Chimera detection
usearch7.0.1090 -uchime_ref usearch_outputs/otus1.fa -db gold.fasta -strand plus -nonchimeras usearch_outputs/otus1.nonchimera.fa
...
usearch7.0.1090 -usearch_global contigs_for_uparse.fasta -db usearch_outputs/otus2.fa -strand plus -id 0.97 -uc usearch_outputs/otu_map.uc

#Generate OTU table
python scripts/uparse_python_scripts/uc2otutab.py usearch_outputs/otu_map.uc > otu_table.txt
```