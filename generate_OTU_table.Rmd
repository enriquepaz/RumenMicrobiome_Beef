...
The [USEARCH 64-bit version](http://drive5.com/usearch/buy64bit.html) was used as this dataset requires more than the 4Gb RAM allowed in the no-charge 32-bit version. Due to licensing obligations, USEARCH could not be included and the following steps to generate the OTU table are not reproducible. The custom and uparse python scripts, gold.fasta.gz, and the generated OTU table are provided in the Github [repository](https://github.com/enriquepaz/RumenMicrobiome_Beef).   
