...
\<SampleName>_S\<SampleNumber>_L001_R\<ReadNumber>_001. The mapping_file.txt links the sample ID to the metadata.
...
After retrieving and renaming the data, the raw files will be located in the fastq_files directory.
...
#dump fastq files from sra files
for sra in *.sra
do
