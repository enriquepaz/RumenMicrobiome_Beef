...
assign_taxonomy.py -i usearch_outputs/otus2.fa -t anaconda2/envs/microbiomeBeef/lib/python2.7/site-packages/qiime_default_reference/gg_13_8_otus/taxonomy/97_otu_taxonomy.txt -r anaconda2/envs/microbiomeBeef/lib/python2.7/site-packages/qiime_default_reference/gg_13_8_otus/rep_set/97_otus.fasta -m mothur -o assigned_gg_taxa
```
...
mothur "#pcr.seqs(fasta=silva/silva.nr_v123.align, start=11894, end=25319, keepdots=F, processors=4)"

#Check for outliers
mothur "#summary.seqs(fasta=silva/silva.nr_v123.pcr.align, processors=8)"

#Remove outliers
mothur "#screen.seqs(fasta=silva/silva.nr_v123.pcr.align, summary=silva/silva.nr_v123.pcr.summary, start=1, end=13425)"
...
```{r, engine='bash'}
#Align sequences
mothur "#align.seqs(fasta=usearch_results/otus2.fasta, reference=silva/silva.v4.fasta)"

#Summarize quality of alignment
mothur "#summary.seqs(fasta=usearch_results/otus2.align)"
```
...
otus_aligned <- read.table("usearch_results/otus2.summary", header = T, sep = "\t", stringsAsFactors = F)
