...
steer_observedotus <- ggplot(data_steer_sub, aes(x=factor(Group), y=ObservedOTUs)) + geom_boxplot() + geom_jitter() + labs(title="Steer", x="", y="") + theme(plot.title=element_text(color="black", size=14, face="bold", hjust=0.5), axis.line.x=element_blank(), axis.line.y=element_line(color="black", size=1), axis.ticks=element_line(color="black"), axis.text.x=element_blank(), axis.text.y=element_text(color="black", size=12, face="bold"), axis.title=element_blank()) + stat_summary(fun.y="mean", geom="point", shape=23, size=3, fill="black")
...
dev.off()
```
![Rarefaction Plots](figures/FigureS4.png)