...
png("figures/FigureS4.png", units="in", height=6, width=12, res=300)
multiplot(heifer_observed_otus, steer_observed_otus, cols=2)
dev.off()

pdf("figures/FigureS4.pdf", height=6, width=12)
multiplot(heifer_observed_otus, steer_observed_otus, cols=2)
dev.off()
```