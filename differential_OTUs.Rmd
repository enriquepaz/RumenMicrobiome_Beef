...
lefse-format_input.py relative_abundance_groups/heifer_rel_ADGLADFIH_ADGHADFIH.txt lefse_outputs/heifer_rel_ADGLADFIH_ADGHADFIH_lefse_format.txt -c 1 -s -1 -u 2 -o 1000000
run_lefse.py lefse_outputs/heifer_rel_ADGLADFIH_ADGHADFIH_lefse_format.txt lefse_outputs/heifer_ADGLADFIH_ADGHADFIH_lefse_result.txt
lefse-plot_res.py lefse_outputs/heifer_ADGLADFIH_ADGHADFIH_lefse_result.txt lefse_outputs/heifer_ADGLADFIH_ADGHADFIH_lefse_result.jpeg --width 12 --height 6 --dpi 300

lefse-format_input.py relative_abundance_groups/heifer_rel_ADGLADFIH_ADGLADFIL.txt lefse_outputs/heifer_rel_ADGLADFIH_ADGLADFIL_lefse_format.txt -c 1 -s -1 -u 2 -o 1000000
run_lefse.py lefse_outputs/heifer_rel_ADGLADFIH_ADGLADFIL_lefse_format.txt lefse_outputs/heifer_rel_ADGLADFIH_ADGLADFIL_lefse_result.txt
lefse-plot_res.py lefse_outputs/heifer_rel_ADGLADFIH_ADGLADFIL_lefse_result.txt 
lefse_outputs/heifer_rel_ADGLADFIH_ADGLADFIL_lefse_result.jpeg --width 12 --height 6 --dpi 300

lefse-format_input.py relative_abundance_groups/heifer_rel_ADGLADFIH_ADGHADFIL.txt lefse_outputs/heifer_rel_ADGLADFIH_ADGHADFIL_lefse_format.txt -c 1 -s -1 -u 2 -o 1000000
run_lefse.py lefse_outputs/heifer_rel_ADGLADFIH_ADGHADFIL_lefse_format.txt lefse_outputs/heifer_rel_ADGLADFIH_ADGHADFIL_lefse_result.txt
lefse-plot_res.py lefse_outputs/heifer_rel_ADGLADFIH_ADGHADFIL_lefse_result.txt lefse_outputs/heifer_rel_ADGLADFIH_ADGHADFIL_lefse_result.jpeg --width 12 --height 6 --dpi 300

lefse-format_input.py relative_abundance_groups/heifer_rel_ADGHADFIH_ADGLADFIL.txt lefse_outputs/heifer_rel_ADGHADFIH_ADGLADFIL_lefse_format.txt -c 1 -s -1 -u 2 -o 1000000
run_lefse.py lefse_outputs/heifer_rel_ADGHADFIH_ADGLADFIL_lefse_format.txt lefse_outputs/heifer_rel_ADGHADFIH_ADGLADFIL_lefse_result.txt
lefse-plot_res.py lefse_outputs/heifer_rel_ADGHADFIH_ADGLADFIL_lefse_result.txt lefse_outputs/heifer_rel_ADGHADFIH_ADGLADFIL_lefse_result.jpeg --width 12 --height 6 --dpi 300

lefse-format_input.py relative_abundance_groups/heifer_rel_ADGHADFIH_ADGHADFIL.txt lefse_outputs/heifer_rel_ADGHADFIH_ADGHADFIL_lefse_format.txt -c 1 -s -1 -u 2 -o 1000000
run_lefse.py lefse_outputs/heifer_rel_ADGHADFIH_ADGHADFIL_lefse_format.txt lefse_outputs/heifer_rel_ADGHADFIH_ADGHADFIL_lefse_result.txt
lefse-plot_res.py lefse_outputs/heifer_rel_ADGHADFIH_ADGHADFIL_lefse_result.txt lefse_outputs/heifer_rel_ADGHADFIH_ADGHADFIL_lefse_result.jpeg --width 12 --height 6 --dpi 300

lefse-format_input.py relative_abundance_groups/heifer_rel_ADGLADFIL_ADGHADFIL.txt lefse_outputs/heifer_rel_ADGLADFIL_ADGHADFIL_lefse_format.txt -c 1 -s -1 -u 2 -o 1000000
run_lefse.py lefse_outputs/heifer_rel_ADGLADFIL_ADGHADFIL_lefse_format.txt lefse_outputs/heifer_rel_ADGLADFIL_ADGHADFIL_lefse_result.txt
lefse-plot_res.py lefse_outputs/heifer_rel_ADGLADFIL_ADGHADFIL_lefse_result.txt lefse_outputs/heifer_rel_ADGLADFIL_ADGHADFIL_lefse_result.jpeg --width 12 --height 6 --dpi 300

#Pairwise comparisons for heifer steer
lefse-format_input.py relative_abundance_groups/steer_rel_ADGLADFIH_ADGHADFIH.txt lefse_outputs/steer_rel_ADGLADFIH_ADGHADFIH_lefse_format.txt -c 1 -s -1 -u 2 -o 1000000
run_lefse.py lefse_outputs/steer_rel_ADGLADFIH_ADGHADFIH_lefse_format.txt lefse_outputs/steer_ADGLADFIH_ADGHADFIH_lefse_result.txt
lefse-plot_res.py lefse_outputs/steer_ADGLADFIH_ADGHADFIH_lefse_result.txt lefse_outputs/steer_ADGLADFIH_ADGHADFIH_lefse_result.jpeg --width 12 --height 6 --dpi 300

lefse-format_input.py relative_abundance_groups/steer_rel_ADGLADFIH_ADGLADFIL.txt lefse_outputs/steer_rel_ADGLADFIH_ADGLADFIL_lefse_format.txt -c 1 -s -1 -u 2 -o 1000000
run_lefse.py lefse_outputs/steer_rel_ADGLADFIH_ADGLADFIL_lefse_format.txt lefse_outputs/steer_rel_ADGLADFIH_ADGLADFIL_lefse_result.txt
lefse-plot_res.py lefse_outputs/steer_rel_ADGLADFIH_ADGLADFIL_lefse_result.txt lefse_outputs/steer_rel_ADGLADFIH_ADGLADFIL_lefse_result.jpeg --width 12 --height 6 --dpi 300

lefse-format_input.py relative_abundance_groups/steer_rel_ADGLADFIH_ADGHADFIL.txt lefse_outputs/steer_rel_ADGLADFIH_ADGHADFIL_lefse_format.txt -c 1 -s -1 -u 2 -o 1000000
run_lefse.py lefse_outputs/steer_rel_ADGLADFIH_ADGHADFIL_lefse_format.txt lefse_outputs/steer_rel_ADGLADFIH_ADGHADFIL_lefse_result.txt
lefse-plot_res.py lefse_outputs/steer_rel_ADGLADFIH_ADGHADFIL_lefse_result.txt lefse_outputs/steer_rel_ADGLADFIH_ADGHADFIL_lefse_result.jpeg --width 12 --height 6 --dpi 300

lefse-format_input.py relative_abundance_groups/steer_rel_ADGHADFIH_ADGLADFIL.txt lefse_outputs/steer_rel_ADGHADFIH_ADGLADFIL_lefse_format.txt -c 1 -s -1 -u 2 -o 1000000
run_lefse.py lefse_outputs/steer_rel_ADGHADFIH_ADGLADFIL_lefse_format.txt lefse_outputs/steer_rel_ADGHADFIH_ADGLADFIL_lefse_result.txt
lefse-plot_res.py lefse_outputs/steer_rel_ADGHADFIH_ADGLADFIL_lefse_result.txt lefse_outputs/steer_rel_ADGHADFIH_ADGLADFIL_lefse_result.jpeg --width 12 --height 6 --dpi 300

lefse-format_input.py relative_abundance_groups/steer_rel_ADGHADFIH_ADGHADFIL.txt lefse_outputs/steer_rel_ADGHADFIH_ADGHADFIL_lefse_format.txt -c 1 -s -1 -u 2 -o 1000000
run_lefse.py lefse_outputs/steer_rel_ADGHADFIH_ADGHADFIL_lefse_format.txt lefse_outputs/steer_rel_ADGHADFIH_ADGHADFIL_lefse_result.txt
lefse-plot_res.py lefse_outputs/steer_rel_ADGHADFIH_ADGHADFIL_lefse_result.txt lefse_outputs/steer_rel_ADGHADFIH_ADGHADFIL_lefse_result.jpeg --width 12 --height 6 --dpi 300

lefse-format_input.py relative_abundance_groups/steer_rel_ADGLADFIL_ADGHADFIL.txt lefse_outputs/steer_rel_ADGLADFIL_ADGHADFIL_lefse_format.txt -c 1 -s -1 -u 2 -o 1000000
run_lefse.py lefse_outputs/steer_rel_ADGLADFIL_ADGHADFIL_lefse_format.txt lefse_outputs/steer_rel_ADGLADFIL_ADGHADFIL_lefse_result.txt
lefse-plot_res.py lefse_outputs/steer_rel_ADGLADFIL_ADGHADFIL_lefse_result.txt lefse_outputs/steer_rel_ADGLADFIL_ADGHADFIL_lefse_result.jpeg --width 12 --height 6 --dpi 300
```
...
heifer_ADGLADFIH_ADGHADFIH_lefse <- read.table("lefse_outputs/heifer_ADGLADFIH_ADGHADFIH_lefse_result.txt", sep="\t", header=F)
...
steer_ADGLADFIH_ADGHADFIH_lefse <- read.table("lefse_outputs/steer_ADGLADFIH_ADGHADFIH_lefse_result.txt", sep="\t", header=F)
